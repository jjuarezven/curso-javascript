...
var allParks = [new Park('Green Park', 1987, 0.2, 2215), new Park('National Park', 1894, 2.9, 3451), new Park('Oak Park', 1953, 0.4, 949)];
...
function reportParks(p) {
    ...
    p.filter(function (el) {
        ...
        return console.log(el.name + ' has more than 1000 trees.');
    });
}
